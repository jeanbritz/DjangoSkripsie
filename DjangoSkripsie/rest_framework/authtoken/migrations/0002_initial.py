...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Token'
        db.create_table(u'authtoken_token', (
            ('key', self.gf('django.db.models.fields.CharField')(max_length=40, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='auth_token', unique=True, to=orm['paySystem.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'authtoken', ['Token'])


    def backwards(self, orm):
        # Deleting model 'Token'
        db.delete_table(u'authtoken_token')
    ...
    models = {
        ...
        u'authtoken.token': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'auth_token'", 'unique': 'True', 'to': u"orm['paySystem.User']"})
        },
        ...
        u'paySystem.user': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'location'", 'null': 'True', 'to': u"orm['paySystem.Locations']"}),
